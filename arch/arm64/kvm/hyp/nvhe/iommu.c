...
#define DRV_ID(drv_addr)			((u64)drv_addr)
 ...
 * Id is the address of the driver.
 */
static inline struct pkvm_iommu_driver *get_driver(u64 id)
{
...
int __pkvm_iommu_register(unsigned long dev_id, u64 drv_id,
