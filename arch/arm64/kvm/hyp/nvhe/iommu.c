...
/*
 * Order of taking locks in this file:
 *    host_kvm.lock >> iommu_list_lock
 */
...
static DEFINE_HYP_SPINLOCK(iommu_list_lock);
			     ...
			     size_t szdata)
{
	...
	/* Take a snaphost of host stage-2. */
					...
					phys_addr_t *end)
{
	...
	/* Must hold host_kvm lock for correctness of device registration. */
