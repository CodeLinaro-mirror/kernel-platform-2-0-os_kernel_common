 ...
 *  to avoid any confusin all names are prefixed with V9
 */
/*New registers*/
#define REG_NS_V9_CTRL_PROTECTION_ENABLE_PER_VID_SET 0x50
#define REG_NS_V9_CTRL_ERROR_RESP_TYPE_PER_VID_SET   0x70
...
#define REG_NS_V9_READ_PTLB_DATA_S1_ENABLE_PPN_AP 0x3040
#define REG_NS_V9_READ_PTLB_DATA_S1_DISABLE_AP_LIST 0x3044
...
#define V9_READ_MPTC_TAG_OTHERS_PAGE_GRANULE_MASK GENMASK(5, 4)
#define V9_READ_MPTC_TAG_OTHERS_MASK (V9_READ_MPTC_TAG_OTHERS_VID_MASK |\
	V9_READ_MPTC_TAG_OTHERS_PAGE_GRANULE_MASK)
...
#define V9_READ_PTLB_TAG_MASK	(V9_READ_PTLB_TAG_VALID_MASK |\
	V9_READ_PTLB_TAG_PAGE_SIZE_MASK | V9_READ_PTLB_TAG_STAGE1_ENABLED_MASK |\
	V9_READ_PTLB_TAG_VID_MASK | V9_READ_PTLB_TAG_TPN_MASK)

#define V9_READ_PTLB_DATA_S1_ENABLE_PPN_AP_S2AP_MASK	GENMASK(25, 24)
#define V9_READ_PTLB_DATA_S1_ENABLE_PPN_AP_PPN_MASK	GENMASK(23, 0)

#define V9_READ_PTLB_DATA_S1_ENABLE_PPN_AP_MASK (V9_READ_PTLB_DATA_S1_ENABLE_PPN_AP_S2AP_MASK |\
	V9_READ_PTLB_DATA_S1_ENABLE_PPN_AP_PPN_MASK)

#define V9_READ_MPTC_INFO_NUM_MPTC_SET GENMASK(31, 16)
#define V9_READ_MPTC_INFO_NUM_MPTC_WAY GENMASK(15, 12)
#define V9_READ_MPTC_INFO_MASK	(V9_READ_MPTC_INFO_NUM_MPTC_SET | V9_READ_MPTC_INFO_NUM_MPTC_SET)
...
#define V9_READ_PMMU_INFO_MASK (V9_READ_PMMU_INFO_NUM_PTLB | V9_READ_PMMU_INFO_VA_WIDTH |\
...
#define V9_READ_MPTC_MASK			(V9_READ_MPTC_WAY_MASK | V9_READ_MPTC_SET_MASK)
...
#define V9_READ_PTLB(pmmu_index, ptlb_index, set, way) (V9_READ_PTLB_WAY(way) |\
	V9_READ_PTLB_SET(set) |  V9_READ_PTLB_PTLB(ptlb_index) | V9_READ_PTLB_PMMU(pmmu_index))

#define V9_READ_SLTB_INFO_SET_MASK	GENMASK(15, 0)
#define V9_READ_SLTB_INFO_WAY_MASK	GENMASK(31, 16)
#define V9_READ_SLTB_INFO_MASK (V9_READ_SLTB_INFO_SET_MASK | V9_READ_SLTB_INFO_WAY_MASK)

#define V9_SWALKER_INFO_NUM_STLB_MASK		GENMASK(31, 16)
#define V9_SWALKER_INFO_NUM_PMMU_MASK		GENMASK(15, 0)
#define V9_SWALKER_INFO_MASK	 (V9_SWALKER_INFO_NUM_STLB_MASK | V9_SWALKER_INFO_NUM_PMMU_MASK)

/*STLB has 2 types A,B based on how S2MPU is connected*/
/*register or masks that vary based on type are suffixed with type*/
...
#define V9_READ_STLB_MASK_TYPEA   (V9_READ_STLB_SET_MASK_TYPEA | V9_READ_STLB_WAY_MASK_TYPEA |\
	V9_READ_STLB_SUBLINE_MASK_TYPEA  | V9_READ_STLB_STLBID_MASK_TYPEA)
...
#define V9_READ_STLB_MASK_TYPEB   (V9_READ_STLB_SET_MASK_TYPEB | V9_READ_STLB_WAY_MASK_TYPEB  |\
...
#define V9_READ_STLB_TPN_MASK    (V9_READ_STLB_TPN_TPN_MASK | V9_READ_STLB_TPN_S2VALID_MASK |\
	V9_READ_STLB_TPN_STAGE1_ENABLED_MASK | V9_READ_STLB_TPN_VALID_MASK)
...
#define V9_READ_STLB_TAG_OTHERS_MASK	(V9_READ_STLB_TAG_OTHERS_S2AP_MASK_TYPEA |\
	V9_READ_STLB_TAG_OTHERS_PS_MASK | V9_READ_STLB_TAG_OTHERS_BPS_MASK |\
...
#define V9_READ_STLB_TYPEA(stlb_index, subline, set, way) (V9_READ_STLB_WAY_TYPEA(way) |\
	V9_READ_STLB_SET_TYPEA(set) | V9_READ_STLB_STLBID_TYPEA(stlb_index) |\
	V9_READ_STLB_SUBLINE_TYPEA(subline))
...
#define V9_READ_STLB_TYPEB(stlb_index,  set, way) (V9_READ_STLB_WAY_TYPEB(way) |\
	V9_READ_STLB_SET_TYPEB(set) | V9_READ_STLB_STLBID_TYPEB(stlb_index))

#define V9_MAX_PTLB_NUM		0x100
#define V9_MAX_STLB_NUM		0x100

#define V9_CTRL0_DISABLE_CHK_S1L1PTW_MASK		BIT(0)
#define V9_CTRL0_DISABLE_CHK_S1L2PTW_MASK		BIT(1)
#define V9_CTRL0_DISABLE_CHK_USER_MARCHED_REQ_MASK	BIT(3)
#define V9_CTRL0_FAULT_MODE_MASK			BIT(4)
#define V9_CTRL0_ENFORCE_FAULT_MODE_S1_NONSEC_MASK	BIT(5)
#define V9_CTRL0_DESTRUCTIVE_AP_CHK_MODE_MASK		BIT(6)
#define V9_CTRL0_MASK	V9_CTRL0_DISABLE_CHK_S1L1PTW_MASK | V9_CTRL0_DISABLE_CHK_S1L2PTW_MASK |\
			V9_CTRL0_DISABLE_CHK_S1L2PTW_MASK | V9_CTRL0_DESTRUCTIVE_AP_CHK_MODE_MASK |\
			V9_CTRL0_ENFORCE_FAULT_MODE_S1_NONSEC_MASK | V9_CTRL0_FAULT_MODE_MASK

/* S2MPU V9 specific values (some new and some different from old versions)
 *  to avoid any confusion all names are prefixed with V9
 *
 */
//changed registers/fields
