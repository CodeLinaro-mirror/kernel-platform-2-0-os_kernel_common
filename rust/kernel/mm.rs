...
pub mod virt {
    ...
    impl Area {
        ...
        pub fn flags(&self) -> usize {
            ...
            unsafe { (*self.vma.get()).vm_flags as _ }
        }
        ...
        pub fn zap_page_range(&self, address: usize, size: usize) {
            ...
            unsafe { bindings::zap_page_range(self.vma.get(), address as _, size as _) };
        }
    }
