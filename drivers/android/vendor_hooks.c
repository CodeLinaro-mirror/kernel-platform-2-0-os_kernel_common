...
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufs_interrupt);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufs_prepare_host_reset);
EXPORT_TRACEPOINT_SYMBOL_GPL(android_vh_ufs_prepare_device_reset);
