...
declare_trace! {
    ...
    fn rust_binder_ioctl_done(ret: c_int);
    fn rust_binder_write_done(ret: c_int);
    fn rust_binder_read_done(ret: c_int);
    fn rust_binder_set_priority(thread: *mut task_struct, desired_prio: c_int, new_prio: c_int);
